...
const subscribe = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.paymentServices.subscribe(userId);
...
const confirmationControllerForSubscription = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { transactionId, status } = req.query;
    const result = yield payment_service_1.paymentServices.confirmationServiceForSubscription(transactionId, status);
    res.send(result);
});
